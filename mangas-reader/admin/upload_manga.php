...
<div class="container py-4">
  <div class="d-flex justify-content-between align-items-center mb-4">
    <h1>Tus mangas</h1>
    <a href="add_manga.php" class="btn btn-warning">Añadir manga</a>
  </div>
          ...
          <div class="card bg-secondary text-light h-100">
           <?php if ($manga['cover_image'] && file_exists(__DIR__ . "/../uploads/" . $manga['cover_image'])): ?>
            ...
            <div class="card-body">
              ...
              <a href="edit_manga.php?id=<?= $manga['id'] ?>" class="btn btn-sm btn-outline-warning">Editar</a>
              <a href="add_chapter.php?manga_id=<?= $manga['id'] ?>" class="btn btn-sm btn-outline-info">Añadir capítulo</a>
