...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['delete'])) {
        ...
        header("Location: edit_chapter.php?id=" . $page['chapter_id']);
        exit();
    }
...
<div class="container py-5 edit-page-container">
    ...
    <form method="post" enctype="multipart/form-data" class="mb-4">
        ...
        <button type="submit" name="replace_image" class="btn btn-warning">
            <span class="icon-loop" style="font-size: 1rem;"></span> Reemplazar
        </button>
    </form>

    <form method="post" onsubmit="return confirm('¿Seguro que quieres eliminar esta página?')">
        <button type="submit" name="delete" class="btn btn-danger">
            <span class="icon-trash" style="font-size: 1rem;"></span>
        </button>
        <a href="edit_chapter.php?id=<?= $page['chapter_id'] ?>" class="btn btn-secondary ms-md-2">
            <span class="icon-undo2" style="font-size: 1rem;"></span>
        </a>
    </form>
</div>
