...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && !isset($_FILES['new_images'])) {
    ...
    // Redirigir con parámetro de éxito para mostrar mensaje
    header("Location: edit_chapter.php?id=$chapter_id&success=1");
    exit();
}
...
<div class="container py-5">
    ...
    <form method="post" class="mb-5">
        ...
        <button type="submit" class="btn btn-warning"><span class="icon-floppy-disk" style="font-size: 0.85rem;"></span> Guardar</button>
    </form>
    ...
    <form method="post" enctype="multipart/form-data" class="mb-5">
        ...
        <button type="submit" class="btn btn-warning"><span class="icon-upload3" style="font-size: 0.85rem;"></span> Subir nuevas páginas</button>
    </form>
    ...
    <?php else: ?>
                ...
                <div class="col">
                    <div class="card bg-secondary text-light h-100">
                        ...
                        <div class="card-body d-flex flex-column justify-content-between">
                            ...
                            <div>
                                <a href="edit_page.php?page_id=<?= $page['id'] ?>" class="btn btn-sm btn-warning me-2"><span class="icon-pencil2" style="font-size: 0.85rem;"></span> Editar</a>
                                <a href="edit_chapter.php?id=<?= $chapter_id ?>&delete_page_id=<?= $page['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('¿Seguro que quieres borrar esta página?')"><span class="icon-trash" style="font-size: 0.85rem;"></span></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="mt-3">
            <a href="reorder_pages.php?chapter_id=<?= $chapter_id ?>" class="btn btn-info"><span class="icon-shuffle" style="font-size: 0.85rem;"></span> Reordenar</a>
            <a href="add_chapter.php?manga_id=<?= $chapter['manga_id'] ?>" class="btn btn-secondary"><span class="icon-undo2" style="font-size: 1rem;"></span></a>
        </div>
    <?php endif; ?>
